...
operands = {
    ...
    "CallWithSpread": lambda obj: f"ACCU = {obj.args[0]}.call({(expand_reg_list_spread(obj.args[1]))})",
    ...
    "LdaConstant": lambda obj: f"ACCU = LiteralConstPool{obj.args[0]}",
    "LdaNamedProperty": lambda obj: f"ACCU = {obj.args[0]}[LiteralConstPool{obj.args[1]}]",
    "LdaNamedPropertyFromSuper": lambda obj: f"ACCU = ACCU[LiteralConstPool{obj.args[1]}]",
    "GetNamedPropertyFromSuper": lambda obj: f"ACCU = ACCU[LiteralConstPool{obj.args[1]}]",
    "GetNamedProperty": lambda obj: f"ACCU = {obj.args[0]}[LiteralConstPool{obj.args[1]}]",
    ...
    "StaNamedOwnProperty": lambda obj: f"{obj.args[0]}[LiteralConstPool{obj.args[1]}] = ACCU",
    "StaNamedProperty": lambda obj: f"{obj.args[0]}[LiteralConstPool{obj.args[1]}] = ACCU",
    ...
    "SetNamedProperty": lambda obj: f"{obj.args[0]}[LiteralConstPool{obj.args[1]}] = ACCU",
